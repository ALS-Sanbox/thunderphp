    ...
    <div class="row">
        ...
        <div class="col-md-4 text-center">
            ...
            <div>
                <label for="iconUpload" style="cursor: pointer;">
                    <img src="<?= esc(get_image($row->icon ?? null)) ?>" alt="Icon" class="img-fluid rounded-circle preview-img" id="previewIcon" style="max-width: 200px; height: auto;">
                </label>
                ...
                <button type="button" class="btn btn-sm btn-outline-danger mt-2" onclick="clearImage('iconUpload', 'previewIcon', '<?= esc(get_image(null)) ?>')">Remove Icon</button>
            </div>

            <!-- Mega Image Upload -->
            <div class="mt-4">
                <label for="megaImageUpload" style="cursor: pointer;">
                    <img src="<?= esc(get_image($row->mega_image ?? null)) ?>" alt="Mega Image" class="img-fluid rounded-circle preview-img" id="previewMegaImage" style="max-width: 200px; height: auto;">
                </label>
                ...
                <button type="button" class="btn btn-sm btn-outline-danger mt-2" onclick="clearImage('megaImageUpload', 'previewMegaImage', '<?= esc(get_image(null)) ?>')">Remove Mega Image</button>
            </div>
        </div>
        ...
        <div class="col-md-8">
            ...
            <div class="mb-3 form-check form-switch">
                <input type="checkbox" class="form-check-input" id="isMega" name="is_mega" value="1" <?= isset($row->is_mega) && $row->is_mega == 1 ? 'checked' : '' ?>>
                <label class="form-check-label" for="isMega">Is Mega</label>
            </div>
            <div class="mb-3 form-check form-switch">
                <input type="checkbox" class="form-check-input" id="active" name="active" value="1" <?= isset($row->disabled) && $row->disabled == 0 ? 'checked' : '' ?>>
